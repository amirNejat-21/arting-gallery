...
const Product = ({productsData}) => {
    ...
    // console.log(productsData.variants)




//     const materialOptions = productsData.variants
//     .map((p) => p.material)
//     .filter((v, i, a) => a.indexOf(v) === i)
//     .map((material) => ({ label: material, value: material }))
//   console.log(materialOptions)

//     const sizeOptions = productsData.variants
//     .map((p) => p.size)
//     .filter((v, i, a) => a.indexOf(v) === i)
//     .map((size) => ({ label: size, value: size }));
//   console.log(sizeOptions)
  
//   const priceOptions = productsData.variants
...
//       }, [productsData])
  ...
  <select class="peer h-full w-full rounded-[7px] border-[2px] border-[var(--counter)] border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 empty:!bg-red-500 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
    <option value="brazil">30*40</option>
    <option value="bucharest">40*40</option>
    <option value="london">50*60</option>
    <option value="washington">80*100</option>
  </select>
